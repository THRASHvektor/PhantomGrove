...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Phantom p_Phantom;
        ...
        public static SteamVR_Input_ActionSet_Phantom Phantom
        {
            get
            {
                return SteamVR_Actions.p_Phantom.GetCopy<SteamVR_Input_ActionSet_Phantom>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Phantom = ((SteamVR_Input_ActionSet_Phantom)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Phantom>("/actions/Phantom")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Phantom};
        }
    }
}
